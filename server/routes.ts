...
export async function registerRoutes(
  ...
  app.post("/api/wopi/files/:id/contents", async (req: Request, res: Response) => {
    try {
  ...
  app.post("/api/wopi/files/:id", async (req: Request, res: Response) => {
    try {
  ...
  // WOPI GetShareUrl
  app.get("/api/wopi/files/:id/share", async (req: Request, res: Response) => {
    try {
  ...
  app.get("/api/wopi/discovery", async (_req: Request, res: Response) => {
    try {
